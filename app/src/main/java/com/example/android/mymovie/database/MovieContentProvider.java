...
import static com.example.android.mymovie.database.MovieContract.MovieEntry.TABLE_NAME;
...
public class MovieContentProvider extends ContentProvider {
    ...
    public static UriMatcher buildUriMatcher() {
        ...
        uriMatcher.addURI(MovieContract.AUTHORITY, MovieContract.PATH_FAV, TASKS);
        uriMatcher.addURI(MovieContract.AUTHORITY, MovieContract.PATH_FAV + "/#", TASK_WITH_ID);
